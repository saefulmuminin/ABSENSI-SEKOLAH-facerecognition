                    ...
                    <div class="card-body mx-5 my-3">
                        ...
                        <form action="<?= base_url('admin/guru/create'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="text" id="nuptk" class="form-control <?= $validation->getError('nuptk') ? 'is-invalid' : ''; ?>" name="nuptk" placeholder="1234" value="<?= old('nuptk') ?? '' ?>">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="number" id="no_hp" name="no_hp" class="form-control <?= $validation->getError('no_hp') ? 'is-invalid' : ''; ?>" placeholder="08969xxx" value="<?= old('no_hp') ?? '' ?>" required>
                                <div class="invalid-feedback">
                            ...
                            <div>
                                <div class="form-title-image">
                                    <p>Ambil gambar untuk sampel face recognition</p>
                                </div>
